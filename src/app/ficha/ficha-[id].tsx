/**
 * app/ficha/[id].tsx
 * Pantalla de detalle de producto — Digital Epicurean
 *
 * resumen de lo utilizado por si se me olvida
 *  - useQuery de TanStack Query para fetch individual (productos.service)
 *  - transformSearchProductsResponse → tipo limpio MyProduct
 *  - Stack.Screen con back button
 *  - Manejo de estados: loading, error, data
 *  - StyleSheet.create con design tokens consistentes
 */
...
// ─── Fetch de un producto individual ─────────────────────────────────────────
...
// ─── Hook dedicado (buena práctica: un hook por recurso) ──────────────────────
