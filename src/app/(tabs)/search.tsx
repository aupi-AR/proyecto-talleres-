...
const C = { bg: "#F5EDE0", surface: "#FFFFFF", text: "#1A1A1A", muted: "#6B7280", border: "#E5E7EB" };

const styles = StyleSheet.create({
  scroll: { flex: 1, backgroundColor: C.bg },
  content: { paddingHorizontal: 20, paddingTop: 60, paddingBottom: 40, gap: 20 },
  title: { fontSize: 28, fontWeight: "800", color: C.text },
  searchBox: { flexDirection: "row", alignItems: "center", backgroundColor: C.surface, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border, gap: 10 },
